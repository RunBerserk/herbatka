...
**0.7.9** workspace line — polishing toward a declared stable **1.0.0** (scope in [v1.md](v1.md)). Hardening pass **complete**; optional throughput work remains under **Next Up**. Early annotated tag **`v1.0.0`** exists on the remote; crate versions and this doc describe the current pre-final line.
...
_(none — hardening pass closed 2026-05-18)_
